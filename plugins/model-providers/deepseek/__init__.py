...
Non-thinking models (explicit V3 ids and unknown ids) are left as
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    future ``deepseek-v4-*`` variants). Explicit V3 ids (``deepseek-v3-*``)
    and unknown ids remain non-thinking.
    """
