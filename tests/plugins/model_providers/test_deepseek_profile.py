...
DeepSeek V4 expects every request to
...
class TestDeepSeekModelGating:
    """V4 family gets thinking; explicit V3 stays untouched."""
...
class TestDeepSeekAuxModel:
    ...
    def test_profile_advertises_v4_flash_aux(self, deepseek_profile):
        assert deepseek_profile.default_aux_model == "deepseek-v4-flash"

    def test_consumer_api_returns_v4_flash_aux(self):
