...
class TestDeepseekCanonicalAndReasonerMapping:
    ...
    def test_legacy_and_reasoner_names_fall_back_to_v4_flash(self, model):
        # Full purge 2026-08-07: legacy aliases + reasoner keywords no longer
        # resolve to dedicated models — everything non-V-series → v4-flash.
