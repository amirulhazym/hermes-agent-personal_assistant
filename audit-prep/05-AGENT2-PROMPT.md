# AGENT 2: Adversarial Audit — Focus on Missing Dimensions

> **Prompt untuk:** Claude / OpenCode / AI coding agent pilihan
> **Tujuan:** Audit dimensi yang Agent 1 (Gemini) completely missed
...
```
Anda adalah AGENT 2 — ADVERSARIAL AUDITOR.

Agent 1 (Gemini) sudah cover:
...
TUGAS ANDA: Audit dimensi BERIKUT yang Agent 1 LANGSUNG TAK SENTUH.
...
Coverage: X/8 dimensions audited
Biggest risk found: ...
Biggest strength: ...
...
- What did Agent 1 miss that's actually important?
- What did Agent 1 find that we confirm/debunk?
...
## Panduan Guna Prompt Ni

| Langkah | Apa Nak Buat |
|---------|-------------|
| 1 | Buka AI agent kau (Claude / OpenCode) |
| 2 | Paste prompt atas ni |
| 3 | Pastikan agent ada access ke: `drive-download-20260707T151046Z-3-001\` dan `hermes-snapshot-20260707\` |
| 4 | Kalau takde rsync snapshot, suruh dia rsync dari VPS |
| 5 | Run |

Lepas dapat response Agent 2, hantar dekat saya. Saya akan:
1. Compare Agent 1 vs Agent 2 findings
2. Verify dari VPS mana yang betul
3. Buat unified fix list
4. Plan execution
