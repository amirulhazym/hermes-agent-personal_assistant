...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # DeepSeek — V4 family ships with a 1M context window.
    # NOTE (2026-08-07): the legacy aliases ``deepseek-chat`` /
    # ``deepseek-reasoner`` were discontinued by DeepSeek on 2026-07-24 and
    # are fully removed from Hermes — only V4 ids remain.
